...
CREATE TABLE `menace` (
  ...
  CONSTRAINT `fk_codeiucn_CodeMenace` FOREIGN KEY (`CodeMenace`) REFERENCES `codeiucn` (`CodeIUCN`)
...
-- Dump completed on 2015-11-12 18:19:55
