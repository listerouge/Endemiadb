...
CREATE TABLE `synonyme` (
  ...
  KEY `fk_nsynonyme_taxon` (`Taxon_idTaxEndemia`),
  CONSTRAINT `fk_nsynonyme_taxon` FOREIGN KEY (`Taxon_idTaxEndemia`) REFERENCES `taxon` (`idTaxEndemia`)
...
-- Dump completed on 2015-11-12 18:11:57
