...
CREATE TABLE `synonyme` (
  ...
  `Taxon_NomScientifique` varchar(255) NOT NULL,
  ...
  KEY `fk_taxon_synonyme` (`Taxon_NomScientifique`),
  CONSTRAINT `fk_taxon_synonyme` FOREIGN KEY (`Taxon_NomScientifique`) REFERENCES `taxon` (`NomScientifique`) ON UPDATE CASCADE
...
-- Dump completed on 2015-12-08  8:56:10
