...
CREATE TABLE `jointhabitattaxon` (
  ...
  KEY `fk_habitat_taxon` (`Taxon_idTaxEndemia`),
  KEY `fk_habitatidhabitat_habitat` (`Habitat_idHabitat`),
  CONSTRAINT `fk_habitat_taxon` FOREIGN KEY (`Taxon_idTaxEndemia`) REFERENCES `taxon` (`idTaxEndemia`),
  CONSTRAINT `fk_habitatidhabitat_habitat` FOREIGN KEY (`Habitat_idHabitat`) REFERENCES `habitat` (`idHabitat`)
