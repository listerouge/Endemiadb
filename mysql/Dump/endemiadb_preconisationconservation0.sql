...
CREATE TABLE `preconisationconservation` (
  ...
  CONSTRAINT `fk_codeiucn_CodePreconisationConservation` FOREIGN KEY (`CodePreconisationConservation`) REFERENCES `codeiucn` (`CodeIUCN`)
...
-- Dump completed on 2015-11-12 18:18:52
