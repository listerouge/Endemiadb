...
CREATE TABLE `serviceecosystemique` (
  ...
  `idEvaluationListeRouge` int(11) NOT NULL,
  `InformationDisponibleInsuffisante` tinyint(1) NOT NULL DEFAULT '1',
  `PasServiceEcosystemique` tinyint(1) NOT NULL DEFAULT '0',
  `CodeServiceEcosystemique` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `CodeIUCN_CategorieServiceEcosystemiqueFR` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `serviceecosystemique` VALUES (1,1,1,0,'','','','','');
