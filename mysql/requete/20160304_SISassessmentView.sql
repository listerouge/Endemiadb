...
CategorieEvaluation AS'RedListCriteria.manualCategory',
if(CategorieEvaluation='NT',replace(CritereEvaluation,CritereEvaluation,null),CritereEvaluation),
PotentiellementEX AS 'RedListCriteria.possiblyExtinct',
PotentiellementEW AS'RedListCriteria.possiblyExtinctCandidate',
PEDerniereAnneeObservation AS'RedListCriteria.yearLastSeen', 
