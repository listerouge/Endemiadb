SELECT Taxon_idTaxEndemia AS 'idTaxEndemia', concat(Genre,' ',Espece) AS 'Taxon', CodeRecherche AS 'CodePreconisationRechercheUICN', DescriptionRecherche, NoteRechercheFR, DureeRecherche FROM endemiadb.preconisationrecherche
